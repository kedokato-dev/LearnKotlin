...
fun lambdaBasicExercises() {
    ...
    val square: (Int) -> Int = { /* TODO: Implement */ 0 }

    // 2.2: Tạo lambda kiểm tra chuỗi có chứa ký tự 'a'
    val containsA: (String) -> Boolean = { /* TODO: Implement */ false }

    // 2.3: Tạo lambda nối hai chuỗi
    val concatenate: (String, String) -> String = { s1, s2 -> /* TODO: Implement */ "" }

    // 2.4: Tạo lambda không có tham số trả về thời gian hiện tại
    val getCurrentTime: () -> String = { /* TODO: Implement */ "" }

    // 2.5: Tạo lambda tính tổng hai số và nhân với một hệ số
    val sumAndMultiply: (Int, Int, Int) -> Int = { a, b, factor -> /* TODO: Implement */ 0 }
